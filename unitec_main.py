...
# importando diretamente variáveis da pasta route
...
'''
# usando bluprint ao invés do @app.route
app.register_blueprint(home_route, url_prefix='/')
# o app.register_blueprint está registrando no flask a variável criada no diretório routes
# que comporta a nossa blueprint  
